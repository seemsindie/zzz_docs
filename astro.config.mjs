	...
	integrations: [
		starlight({
			...
			head: [
				{
					tag: 'script',
					content: `window.op=window.op||function(){var n=[];return new Proxy(function(){arguments.length&&n.push([].slice.call(arguments))},{get:function(t,r){return"q"===r?n:function(){n.push([r].concat([].slice.call(arguments)))}} ,has:function(t,r){return"q"===r}}) }();window.op('init',{clientId:'89b59a58-f5a1-4d82-86de-c85758051a76',apiUrl:'https://opapi-to4gkg0k0wwcs0kkgwscs04s.indielab.link',trackScreenViews:true,trackOutgoingLinks:true,trackAttributes:true});`,
				},
				{
					tag: 'script',
			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Flash Messages', slug: 'core/flash-messages' },
						{ label: 'Secure Cookies', slug: 'core/secure-cookies' },
						{ label: 'Security Headers', slug: 'core/security-headers' },
						{ label: 'Pagination', slug: 'core/pagination' },
						{ label: 'Form Builder', slug: 'core/form-builder' },
						{ label: 'Input Sanitization', slug: 'core/sanitize' },
						{ label: 'IP Allow/Blocklist', slug: 'core/ip-access' },
						{ label: 'Throttle', slug: 'core/throttle' },
						{ label: 'Action Log', slug: 'core/action-log' },
						{ label: 'Range Requests', slug: 'core/range-requests' },
						{ label: 'Locale & i18n', slug: 'core/i18n' },
						{ label: 'File Storage', slug: 'core/storage' },
					],
				},
				{
					label: 'Templates',
