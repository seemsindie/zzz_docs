...
description: "Build, configure, and deploy your pidgn application to production."
---

import { Steps, Tabs, TabItem } from '@astrojs/starlight/components';

Zig produces statically-linked, single-binary executables with no runtime dependencies. This makes pidgn applications straightforward to deploy -- copy the binary, set environment variables, and run.
...
pidgn uses `.env` files and system environment variables for runtime configuration. The `Env` loader follows this precedence (highest to lowest):
...
[Unit]
Description=My pidgn application
