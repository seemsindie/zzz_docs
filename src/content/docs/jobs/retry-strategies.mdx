...
description: "How zzz_jobs handles failed jobs with exponential, linear, constant, and custom retry strategies, including max attempts and dead letter behavior."
---
