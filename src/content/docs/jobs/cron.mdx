...
description: "Schedule recurring background jobs in zzz_jobs using standard 5-field cron expressions with timezone support."
---
...
```zig
const expr = try zzz_jobs.CronExpr.parse("0 9 * * *");
