...
description: "Using htmx with the zzz web framework -- middleware for request detection, response header helpers, partial rendering for fragments, and patterns for building interactive UIs."
---

import { Tabs, TabItem, Steps } from '@astrojs/starlight/components';

zzz provides first-class support for [htmx](https://htmx.org) through a middleware that detects htmx requests, context helpers that set htmx response headers, and partial rendering for returning HTML fragments without a layout wrapper.
