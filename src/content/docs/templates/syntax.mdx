...
description: "Complete reference for zzz template syntax -- variable interpolation, HTML escaping, conditionals, loops, with blocks, comments, raw blocks, and dot notation."
---
