...
.dependencies = .{
    .pidgn_template = .{
        .url = "git+https://github.com/seemsindie/pidgn_template#aec20dc6144c986523efc04b83c014a5ac3b9d86",
        .hash = "pidgn_template-0.3.1-beta.1-vkexMPsAAQDOQ58b2BjcKJjQDlpNm2LJRZ-jcdXSM7_6",
    },
},
```
