...
description: Use pidgn gen to generate controllers, models, channels, and mailers from the command line.
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

The `pidgn gen` command (short for `pidgn generate`) creates boilerplate code from built-in templates. It supports four generator types: controllers, models, channels, and mailers.

## Usage

```bash
pidgn gen <type> <Name> [options...]
```
...
- `src/mailers/templates/<name>.html.pidgn` -- HTML email template
- `src/mailers/templates/<name>.txt.pidgn` -- plain-text email template
...
<Tabs>
  ...
  <TabItem label="With templates">
    ...
    # Generated: src/mailers/welcome.zig
    # Generated: src/mailers/templates/welcome.html.pidgn
    # Generated: src/mailers/templates/welcome.txt.pidgn
    ```
  </TabItem>
</Tabs>
