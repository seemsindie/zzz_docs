...
description: "Real-time bidirectional communication with WebSockets in zzz, including upgrade middleware, connection handling, and sending or receiving messages."
---
...
- [zzz.js Client](/websockets/zzz-js-client/) -- connect to WebSocket endpoints from the browser with auto-reconnect
