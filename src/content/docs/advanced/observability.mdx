---
title: "Observability"
description: "Set up structured logging, Prometheus metrics, telemetry hooks, request IDs, and health check endpoints in your zzz application."
---
...
```json
{"level":"info","method":"GET","path":"/api/users","status":200,"duration_us":142,"request_id":"zzz-a1b2c3-0"}
```
