...
description: "Understand the I/O backend abstraction in zzz, choose between the native zzz backend and the libhv event-loop backend, and configure server options for your deployment target."
---
...
| Consideration | zzz (native) | libhv |
|--------------|-------------|-------|
